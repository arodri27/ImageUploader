...
##############################################
#$exp = "select * from itm544ars where id = '$mbody'";
...
#########################################################################
# Upload the image watermarked to the original bucket
#########################################################################
$newfilename="stamped".$filename;
...
$finishedurl = $s3urlprefix.$bucket."/".$newfilename;
